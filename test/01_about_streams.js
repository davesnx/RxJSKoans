...
test('nothing listens until you subscribe', function () {
  var sum = 0
  var numbers = Observable.from(Range.create(1, 10))
  var observable = numbers.tap(function (n) { sum += n })
...
test('events while subscribing', function () {
  var received = []
  var words = new Subject()
  var observable = words.tap(received.push.bind(received))
